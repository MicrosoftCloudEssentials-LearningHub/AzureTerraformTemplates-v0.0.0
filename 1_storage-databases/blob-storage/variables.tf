...
variable "resource_group_name" {
  description = "The name of the Azure Resource Group to associate the Storage Account and Blob Container with."
  type        = string
}
...
variable "container_access_type" {
  description = "The access type for the Blob Container (private, blob, container)."
  type        = string
}
